...
export class HierarchyService {
  ...
  async importCitizens(citizens: Citizen[]): Promise<Citizen[]> {
    ...
    return await this.citizenRepository.save(citizens)
  }

  async deleteCitizens(): Promise<void> {
    await this.groupRepository.query(`TRUNCATE TABLE "group" CASCADE;`)
    await this.groupRepository.query(`TRUNCATE TABLE "citizen" CASCADE;`)
  }
